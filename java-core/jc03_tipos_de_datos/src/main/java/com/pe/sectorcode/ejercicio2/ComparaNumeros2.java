 ...
 *
 */
public class ComparaNumeros2 {

	
	/**
	 * funcion para mostrar el numero ingresado en letras
	 * @param numero
	 */
	...
	public void procesar ()
	{
		...
		if (numero1 > 10 || numero2 > 10) {
			...
			System.out.println("El primer n�mero es :");
			mostrarnumero(numero1);

			System.out.println("El segundo n�mero es :");
	...
	public static void main(String[] args) {
		...
		ComparaNumeros2 instancia = new ComparaNumeros2();
